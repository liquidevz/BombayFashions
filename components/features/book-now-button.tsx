...
export default function BookNowButton() {
  ...
  return (
    <>
      <motion.div className="fixed bottom-6 right-6 z-20" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
        <Button onClick={toggleModal} className="book-now-btn shadow-lg" icon={<Phone className="h-5 w-5" />}>
          Book Now
        </Button>
      </motion.div>
